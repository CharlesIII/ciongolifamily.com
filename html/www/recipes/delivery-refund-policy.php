...
?>
                <title>Web Recipe Manager - Delivery & Refund Policy</title>
                ...
                <div class=container>
                    <div class="row">
                        <div class="col-xs-12 col-sm-9">
                                <h1><strong>delivery & refund </strong>policy</h1>
                                <div id="accordion">
                                        <h3>subscriptions:</h3>
                                        <div>
                                                <p>
                                ...
                                <br>
                                <br>
                                We would appreciate <a href="contact-us.php">feedback</a> if you cancelled due to any concerns with Web Recipe Manager's functionality, services, etc.
                        </div> 
        <?php
