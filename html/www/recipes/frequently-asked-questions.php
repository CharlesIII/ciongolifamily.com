...
?>
                <title>Web Recipe Manager - Frequently asked questions</title>
                <meta name="description" content="Most frequently asked questions regarding Web Recipe Manager">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-9">
                                ...
                                <div id="accordion">
                                        ...
                                        <div>
                                                <p>
                                                Web Recipe Manager allows you to export recipes in Meal Master, Microsoft Word or CSV format. So you can import your recipes into any recipe software that supports imports in these formats. Please <a href='contact-us.php'>let us know</a> if there are any other formats you would like us to consider.
                                                </p>
                                        </div>
